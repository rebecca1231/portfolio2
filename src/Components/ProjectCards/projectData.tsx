...
export const projectData = [
  {
    ...
    slug: 'opine',
    title: 'Opine',
    description: 'This web application gathers information via email, and charts the resulting data.',
  ...
  },
  {
    ...
    skill: 'I built a JamStack frontend and a custom Strapi CMS on the backend.',
  ...
  //   image1: null,
  //   slug: 'hex-grid-game',
  //   title: 'Hexagonal Grid Game',
  //   description: 'Fun game using modern React and Typescript, utilizing AI agents to speed the build process.',
  //   skill: '',
  //   tech: 'Typescript, React, ',
  //   github: 'https://www.github.com/rebecca1231/hex-grid-game',
  //   details: '',
  // },
